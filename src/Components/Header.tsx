...
export default function Header() {
  ...
  return (
    <div>
      <RxHamburgerMenu
        className={`absolute top-[2.4rem] right-[2.4rem] md:right-[12rem] md:top-[4.8rem] text-[2.4rem] z-10 ${
      ...
      transition-right duration-500 xl:static xl:flex-row xl:text-[1.6rem] xl:border-[2px] xl:gap-[1.6rem] xl:border-green xl:rounded-[5rem] xl:py-[2.7rem] xl:justify-between xl:px-[5.6rem] xl:translate-x-0 xl:bg-transparent`}
      >
