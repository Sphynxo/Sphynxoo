...
export default function Info({
  ...
  return (
    <Accordion
      ...
      className="gap-[2rem] xl:gap-0 border-[2px] w-full border-green rounded-[2.4rem] py-[2.4rem] xl:py-[3.2rem] px-[2.4rem] xl:w-[36rem] md:px-[4rem] h-full flex flex-col items-center justify-between 3xl:w-[40rem] 3xl:py-[4.8rem]"
    >
      <AccordionHeader
      ...
      <AccordionBody>
        <div
          ...
          } transition-opacity duration-500 flex flex-col gap-[2rem] 3xl:gap-[4.4rem]`}
        >
          ...
          <div className="text-center flex flex-col items-center gap-[0.8rem] 3xl:gap-[1.6rem]">
            ...
            <div className="flex items-center gap-[0.8rem]">
              ...
              <p className="text-[1.6rem] text-green">Brooklyn, NY</p>
            </div>
          </div>
